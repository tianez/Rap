...
export default class ApprovedSteps extends Component {
    render() {
        let { formRecordVo, workflowVo } = this.props;
                        ...
                        <Step
                            title={
                                <div className={styles.title}>
                                    <span className={styles.username}>{formRecordVo.user.userName}</span>
                                    <span className={styles.action}>发起申请</span>
                                    <span className={styles.time}>{formRecordVo.createTime}</span>
                                </div>
                            }
                            icon={
                                <span className={styles.stepsicon}>
                                    {formRecordVo.user.userName && formRecordVo.user.userName.slice(0)}
                                </span>
                            }
                        />
